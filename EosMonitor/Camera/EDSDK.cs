...
namespace EDSDKLib
{
    ...
    public class EDSDK
    {
        ...
        #region Camera status commands

        /*----------------------------------
         cameraModel Status Commands
        ----------------------------------*/
        ...
        /*-----------------------------------------------------------------------------
         File CreateBitMask Disposition
        -----------------------------------------------------------------------------*/
        ...
        /*--------------------------------------------
          cameraModel operating functions
        ---------------------------------------------*/ 
        /*-----------------------------------------------------------------------------
        //
        ...
        //  Description:
        //      Specifies the camera's focus and zoom frame position in the InitLiveView state.
        //  
        //  Parameters:
        //      In:    inCameraRef - Designate the camera object. 
        //             inFramePoint - Specifies the position coordinates of the zoom and AF 
        //                 frames of a InitLiveView image.
		...
		//
		//  Parameters:
		//      In:     inCameraRef - The cameraModel reference.
       ...
       -----------------------------------------------------------------------------*/
        ...
        internal static readonly uint CameraCommand_ShutterButton_Completely_NonAF;
